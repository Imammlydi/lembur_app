...
const ReportList = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-6">
            ...
            <h2 className="mb-4 font-Bitter text-2xl font-bold uppercase">
                report list
            </h2>
            {loading ? (
                ...
                reports.map((report) => (
                    <>
                        <div
                            key={report.id}
                            className="border-gray-300 mb-4 rounded  border-opacity-20 p-4 shadow-lg"
                        >
                            <div>
                            ...
                            ID Pemeriksa: {report.inspector_id}
                                ...
                                <div className="mt-6 flex items-center justify-between ">
                                    ...
                                    <div className="flex items-center">
                                        <button
                                            className="bg-red-500 rounded px-4 py-2 text-red1"
                                            onClick={() =>
