...
const tanggalSekarang = new Date().toLocaleDateString('id-ID', optionsx);
    ...
    useEffect(() => {
        console.log("Bulan:", bulan,tanggalSekarang);
        console.log("Tahun:", tahun);
    }, [token, bulan, tahun,tanggalSekarang]);
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <Kwitansi nama_karyawan={namaKaryawan} jabatans={jabatan} totlaLemburMalam={totalL} totalSM={totalL2} tanggal={tanggalSekarang}/>
