...
function DetailKaryawan() {
    ...
    const optionsx = { year: 'numeric', month: 'long', day: 'numeric' };
const tanggalSekarang = new Date().toLocaleDateString('id-ID', optionsx);

    useEffect(() => {
        console.log(token, "--------id ", id_karywan, selectedTime);
        console.log("--------id ", state, tanggalSekarang, "---------");
        // fetchKaryawan();
        fetchLemburMalam();
        fetchKaryawanById();
        fetchLemburSm();
        setLoading(true);
    }, [token, id_karywan, tahun,tanggalSekarang]);

    const fetchKaryawan = async () => {
        try {
            const response = await axios.get(`${API_URL2}/karyawan`, {
                headers: {
    ...
    const fetchLemburMalam = async () => {
        try {
            const response = await axios.get(
                `${API_URL2}/lembur-malam-karyawan-date/${id_karywan}?bulan=${selectedMonth}&tahun=${selectedYear}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
            ...
            console.log(
                response.data,
                "--------",
                `${API_URL2}/lembur-malam-karyawan/${id_karywan}`
            );
    ...
    const fetchLemburSm = async () => {
        try {
            const response = await axios.get(
                `${API_URL2}/lembur-sm-karyawan-date/${id_karywan}?bulan=${selectedMonth}&tahun=${selectedYear}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
    ...
    const createLemburSm = async () => {
        ...
        try {
            const response = await axios.post(
                `${API_URL2}/lembur-sabtu-minggu-merah`,
                {
                    tanggal_lembur: tanggalLemburSiang,
                    mulai: selectedTimeSiang,
                    selesai: selectedTimeEndSiang,
    ...
    const deleteLemburMalam = async (id) => {
        try {
            await axios.delete(`${API_URL2}/lembur-malam/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
    ...
    const deleteLemburSm = async (id) => {
        try {
            await axios.delete(`${API_URL2}/lembur-sabtu-minggu-merah/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            });
            ...
            <div className="mb-2 grid grid-cols-1 items-center gap-1 lg:grid-cols-3">
                <div className=" rounded-lg  p-2 shadow-md">
                    ...
                    <div className=" font-Bitter text-lg ">
                        Nama :<p className="font-bold"> {loading == true ?     <ReactLoading
                        type={"spin"}
                        color={"#0388fc"}
                        height={22}
                        width={22}
                    ...
                    <div className=" font-Bitter text-lg ">
                        Jabatan :<p className="font-bold"> {loading == true ?     <ReactLoading
                        type={"spin"}
                        color={"#0388fc"}
                        height={22}
                        width={22}
                ...
                <div className="rounded-lg border-2 border-green1 p-2 shadow-md">
                    <div className=" font-Bitter text-lg ">
                        {" "}
                        Lembur Malam : <p className="font-bold">{loading == true ?     <ReactLoading
                        type={"spin"}
                        color={"#0388fc"}
                        height={22}
                        width={22}
                    ...
                    <div className=" font-Bitter text-lg ">
                        Lembur Siang: <p className="font-bold">{loading == true ?     <ReactLoading
                        type={"spin"}
                        color={"#0388fc"}
                        height={22}
                        width={22}
